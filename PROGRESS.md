...
| 2026-04-02 | AI 模型：moonshot-v1-auto (OpenAI 兼容) | kimi-for-coding 仅限 Coding Agent，改用通用 API |
...
| 2026-04-03 | 审查 | 代码审查：修复 Dashboard API 形状不匹配、kvGet JSON.parse 安全、Review 评分无响应检查、Quiz 空题组、会话压缩过时快照等 19 项 bug；记录 15 项技术债到 KNOWN_ISSUES.md |
